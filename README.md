...
- Levine blocked video (completes full loops): **10** Points
- Levine obstacles video (passes at least 3 of the 5 obstacles): **10** Points
- Video on physical hardware (team): **10** Points

- Submitted hardware video but no obstacle placed to demonstrate avoidance: **-5** Points
